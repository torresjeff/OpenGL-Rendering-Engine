...
AdvancedDataComponent::AdvancedDataComponent(Application& application, Camera& camera)
	: DrawableGameComponent(application, camera)
{}

void AdvancedDataComponent::Initialize()
{
...
void AdvancedDataComponent::Draw(float DeltaSeconds)
{
	GLint viewLocation;
