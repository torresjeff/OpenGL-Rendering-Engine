...
void CubemapComponent::Draw(float DeltaSeconds)
{
	GLint viewLocation;
	...
	{
		cout << "Camera position location = -1" << endl;
		return;
	}
	...
	glUniform3f(cameraPositionLocation, mCamera->GetPosition().x, mCamera->GetPosition().y, mCamera->GetPosition().z);
