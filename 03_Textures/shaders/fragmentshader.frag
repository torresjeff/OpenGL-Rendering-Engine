...
void main()
{
	...
	color = mix(texture(ourTexture, TexCoord), texture(ourTexture2, TexCoord), interpolation); //mix: linearly interpolates between two values, based on the third argument (0.2).
}