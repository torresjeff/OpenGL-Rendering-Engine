...
DepthTestingComponent::DepthTestingComponent(Application& application, Camera& camera)
	: DrawableGameComponent(application, camera)
{}

void DepthTestingComponent::Initialize()
{
	mVertices =
	{
		//FRONT FACE
...
void DepthTestingComponent::Draw(float DeltaSeconds)
{
